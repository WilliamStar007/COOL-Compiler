...
A.test:                 ## method definition
                        ...
                        subq %r14, %rsp
                        ## return address handling
                        ## fp[4] holds argument b (B)
                        ## fp[3] holds argument a (A)
                        ## method body begins
                        movq %r12, %r13
.globl A.test.end
A.test.end:             ## method body ends
                        ## return address handling
                        movq %rbp, %rsp
                        popq %rbp
                        ret
...
B.a:                    ## method definition
                        ...
                        movq 16(%r12), %r14
                        ## look up test() at offset 5 in vtable
                        movq 40(%r14), %r14
                        call *%r14
                        addq $24, %rsp
                        popq %rbp
