...
subprocess.run(["chmod", "a+x", "tests/./cool-osx"])
local_debug = False
...
def is_valid():
    ...
    correct_result = subprocess.run(["tests/./cool-osx", "--x86", test_f], capture_output=True, text=True)
...
def set_globals(cool_f):
    ...
    subprocess.run(["tests/./cool-osx", "--type", cool_f])
